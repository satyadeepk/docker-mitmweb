...
RUN pip wheel -w /dist https://github.com/mitmproxy/mitmproxy/archive/v4.0.3.tar.gz
...
RUN pip install --no-index --find-links=/wheels /wheels/mitmproxy-4.0.3-py3-none-any.whl
